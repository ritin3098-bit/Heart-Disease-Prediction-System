...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'prediction.context_processors.site_info',  # Custom context processor
            ],
            'libraries': {
                'custom_tags': 'prediction.templatetags.custom_tags',
                'math_filters': 'prediction.templatetags.math_filters',
            },
        },
    },
]
